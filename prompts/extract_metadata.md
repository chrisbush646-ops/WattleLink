...
## DOI rule
Do NOT extract or include a DOI in your output. DOIs are extracted separately via PDF metadata and regex matching, then verified against CrossRef. Leave the doi field out of your response entirely.
